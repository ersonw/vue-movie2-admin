<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="归类量" min-width="150px">
        <template slot-scope="{row}">
          <span>{{ row.count }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="类名">
          <el-input v-model="temp.name" type="text" placeholder="类名" />
        </el-form-item>
      </el-form>
...
import { checkUser } from '@/api/RechargeCentre'
import { deleteClass, getActor, getActorVideos, getClass, getClassList, addClass, updateClass } from '@/api/videos'
let classMap = []
let actorMap = []
export default {
  // name: 'UsersList',
