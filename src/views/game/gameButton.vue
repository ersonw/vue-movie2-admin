<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input v-model="listQuery.title" placeholder="按钮金额" style="width: 300px;" class="filter-item" @keyup.enter.native="handleFilter" />
    ...
    >
      ...
      <el-table-column label="优惠" class-name="status-col" width="100">
        <template slot-scope="{row}">
          <el-tag :type="row.less===1?'success':'info'">
            {{ row.less | lessFilter }}
          </el-tag>
        </template>
      </el-table-column>
