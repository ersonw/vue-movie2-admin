...
<script>
import { getAuditCommentList, deleteAuditComments, denyAuditComments, passAuditComments } from '@/api/shortVideo'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getAuditCommentList(this.listQuery).then(response => {
