...
<script>
import { getMembershipListExperience, deleteMembershipListExperience } from '@/api/membership'
...
export default {
  ...
  methods: {
    getList() {
      ...
      getMembershipListExperience(this.listQuery).then(response => {
    ...
    handleDeleteAll() {
      deleteMembershipListExperience({ 'ids': this.ids }).then(data => {
        this.$notify({
          title: 'Success',
          message: '批量删除成功',
          type: 'success',
    ...
    handleDelete(row, index) {
      var data = []
      data.push(row.id)
      deleteMembershipListExperience({ 'ids': data }).then(data => {
        this.$notify({
          title: 'Success',
          message: '删除成功',
          type: 'success',
