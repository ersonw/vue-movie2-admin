...
import { addDiamond, checkUser, deleteDiamond, getDiamondList, updateDiamond } from '@/api/RechargeCentre'
export default {
  // name: 'UsersList',
  ...
  methods: {
    ...
    getList() {
      ...
      getDiamondList(this.listQuery).then(response => {
